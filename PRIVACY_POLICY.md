## Color Guessing Game: Privacy policy

PRIVACY POLICY FOR MOBILE APPLICATION "Guess the Color"
Last updated: August 30, 2022

This privacy policy governs your use of the software application “Guess the Color” (later referred as the/this “Application”) for Android™ mobile devices that was created by Naman Bajaj.

The application is a mobile Android game in which the user attempts to guess what color is presented on the screen.
...
All score details are only stored locally on your mobile device, within the Application private folder, following Android’s security best practices.
...
Children
Our Application is intended for children under the age of 13. We do not knowingly collect personally identifiable information from anyone under the age of 13. We do not use the Application to knowingly solicit data from or market to children under the age of 13.
